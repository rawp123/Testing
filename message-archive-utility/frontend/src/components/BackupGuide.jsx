...
const BACKUP_STEPS = [
  "Connect your iPhone to this computer with a cable.",
  "Open Finder.",
  ...
  "Under Backups, select the option to back up all iPhone data to this computer.",
  ...
  return (
    <details className={`backup-guide ${compact ? "is-compact" : ""} ${className}`.trim()}>
      ...
      <div className="backup-guide-body">
        <p>This app needs an unencrypted local iPhone backup on this computer.</p>
        <ol>
